...
DEFAULT_RECIPES: list[dict] = [
    ...
    # 1:8 ratio, 144 ml brew + bypass for hot (110 ml) / iced (25 ml)
    {
        ...
        "pours": [
            {"volume": 21, "temperature": 95, "pausing": 0,  "flow_rate": 3.5, "pattern": "spiral", "vibration": "none"},
            {"volume": 21, "temperature": 95, "pausing": 14, "flow_rate": 3.5, "pattern": "spiral", "vibration": "after"},
            {"volume": 52, "temperature": 95, "pausing": 16, "flow_rate": 3.5, "pattern": "spiral", "vibration": "after"},
            {"volume": 25, "temperature": 95, "pausing": 20, "flow_rate": 3.0, "pattern": "spiral", "vibration": "none"},
            {"volume": 25, "temperature": 93, "pausing": 0,  "flow_rate": 3.0, "pattern": "spiral", "vibration": "none"},
        ],
    },
    {
        "name": "약배전 아이스",
    ...
    # 1:8 ratio, 144 ml brew + bypass for hot (110 ml) / iced (25 ml)
    {
        ...
        "pours": [
            {"volume": 36, "temperature": 88, "pausing": 40, "flow_rate": 3.0, "pattern": "spiral", "vibration": "after"},
            {"volume": 72, "temperature": 86, "pausing": 32, "flow_rate": 3.5, "pattern": "spiral", "vibration": "after"},
            {"volume": 36, "temperature": 85, "pausing": 16, "flow_rate": 3.5, "pattern": "spiral", "vibration": "none"},
        ],
    },
    {
        "name": "강배전 아이스",
    ...
    # 1:8 ratio, 160 ml brew + bypass for hot (120 ml) / iced (30 ml)
    {
        ...
        "pours": [
            {"volume": 21, "temperature": 100, "pausing": 0,  "flow_rate": 3.5, "pattern": "spiral", "vibration": "none"},
            {"volume": 21, "temperature": 95,  "pausing": 15, "flow_rate": 3.5, "pattern": "spiral", "vibration": "after"},
            {"volume": 58, "temperature": 95,  "pausing": 15, "flow_rate": 3.5, "pattern": "spiral", "vibration": "after"},
            {"volume": 30, "temperature": 94,  "pausing": 20, "flow_rate": 3.0, "pattern": "spiral", "vibration": "none"},
            {"volume": 58, "temperature": 93,  "pausing": 0,  "flow_rate": 3.0, "pattern": "spiral", "vibration": "none"},
        ],
    },
    {
        "name": "중약배전 워시드 아이스",
    ...
    #    https://xbloom.com/products/pepperpot-tea-hibiscus-berry
    {
        ...
        "total_water": 240,
        "pours": [
            {"volume": 120, "temperature": 100, "pausing": 300},
            {"volume": 120, "temperature": 100, "pausing": 120},
        ],
    },
    ...
    #    https://xbloom.com/products/china-breakfast
    {
        ...
        "total_water": 240,
        "pours": [
            {"volume": 120, "temperature": 95, "pausing": 180},
            {"volume": 120, "temperature": 95, "pausing": 120},
        ],
    },
    ...
    #    https://xbloom.com/products/liang-family-green-tea
    {
        ...
        "total_water": 240,
        "pours": [
            {"volume": 120, "temperature": 80, "pausing": 120},
            {"volume": 120, "temperature": 80, "pausing": 60},
        ],
    },
